...
from agents.tools import fetch_user_flight_information
from utils.utils import create_entry_node, create_tool_node_with_fallback
from IPython.display import Image, display
from agents.schema import CompleteOrEscalate
...
try:
    ...
    image_bytes = part_4_graph.get_graph(xray=True).draw_mermaid_png()
